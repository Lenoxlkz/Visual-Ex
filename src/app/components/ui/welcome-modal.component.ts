  ...
  template: `
    @if(isVisible()) {
      <div class="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
         <app-glass-card [className]="'max-w-md w-full p-6 sm:p-8 flex flex-col gap-6'">
            ...
            <div class="flex items-center gap-2 mt-2 ml-1 cursor-pointer select-none" (click)="toggleDontShow()">
